            ...
            <div v-if="productList.length">
              <div v-for="(item, index) in productList" :key="index" class="list-content list-box">
                ...
                <div class="list-item list-operation-box">
                  <router-link v-if="item.complete_status * 1 === 0" tag="span" :to="'edit-supply-goods?complete=1&id=' + item.id" append class="list-operation ">完善资料</router-link>
    ...
    methods: {
      ...
      _getUrl() {
        ...
        let params = `access_token=${token.access_token}&current_corp=${currentId}&goods_material_category_id=${
          this.goodsReqData.goods_material_category_id
        }&complete_status=${this.goodsReqData.complete_status}&keyword=${this.goodsReqData.keyword}&show_type=base`
