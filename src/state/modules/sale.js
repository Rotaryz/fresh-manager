...
export const actions = {
  ...
  getSaleList({state, commit, dispatch}, {page, startTime = '', endTime = '', loading = false}) {
    return API.Sale.getSaleList({page: page, start_at: startTime, end_at: endTime, activity_type: 'fixed'}, loading)
      .then((res) => {
        if (res.error !== app.$ERR_OK) {
          return false
        }
