!(function() {
  var $ = (function() {
    ...
    ;((D.fn.init = function(e, t) {
      ...
      if (typeof e === 'string') {
        if (
          !(n = e.charAt(0) === '<' && e.charAt(e.length - 1) === '>' && e.length >= 3 ? [null, e, null] : H.exec(e)) ||
          (!n[1] && t)
        )
          ...
          if (y && (l = y.events)) {
            for (t = (t || '').match(P) || [''], u = t.length; u--; )
              if (((s = U.exec(t[u]) || []), (p = v = s[1]), (h = (s[2] || '').split('.').sort()), p)) {
                ...
                c &&
                  !f.length &&
                  ((d.teardown && !1 !== d.teardown.call(e, h, y.handle)) || D.removeEvent(e, p, y.handle), delete l[p])
  ...
  !(function(e, t) {
    ...
    var l = (function() {
      ...
      return (function(t) {
        ...
        return (a && e(a, '53.0.2785.116') < 0 && n && e(n, '3.53.991.400') < 0 && o && e(o, '9.0.2524.400') <= 0) || !1
      })(navigator.userAgent)
    })()
